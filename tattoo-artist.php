...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='tattoo-artist' and status='1'");
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="tattoo-artist.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ଟାଟୁ-ଆର୍ଟିଷ୍ଟ.php" class="language-odia">ଓଡିଆ</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
