...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='nutritionist' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="nutritionist.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ପୋଷଣ ବିଜ୍ଞାନୀ.php" class="language-odia">ଓଡିଆ</a>
