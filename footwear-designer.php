...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='footwear-designer' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="footwear-designer.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଫୁଟ୍ ୱେର୍ ଡିଜାଇନର୍.php" class="language-odia">ଓଡିଆ</a>
