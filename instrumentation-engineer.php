...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='instrumentation-engineer' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="instrumentation-engineer.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଇନଷ୍ଟ୍ରୁମେଣ୍ଟେସନ୍ ଇଞ୍ଜିନିୟର.php" class="language-odia">ଓଡିଆ</a>
									...
									<div class="psefology-skill-spea">
										...
										<div class="row yogendra-head">
											...
											<div class="col-md-10 col-9">
												...
												<p class="Yogendra-heading"><b>

														<?= $details['sucees_stitle']; ?>
