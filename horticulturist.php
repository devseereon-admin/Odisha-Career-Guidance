...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='horticulturist' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="horticulturist.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଉଦ୍ୟାନ ବିଜ୍ଞାନୀ.php" class="language-odia">ଓଡିଆ</a>
