...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='software-engineer' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="software-engineer.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ସଫ୍ଟୱେର ଇଞ୍ଜିନିୟର.php" class="language-odia">ଓଡିଆ</a>
