...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='real-estate-consultant' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="real-estate-consultant.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ରିଅଲ୍ ଇଷ୍ଟେଟ୍ ପରାମର୍ଶଦାତା.php" class="language-odia">ଓଡିଆ</a>
