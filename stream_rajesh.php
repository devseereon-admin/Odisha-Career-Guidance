...
<!-- End Google Tag Manager (noscript) -->
		...
		<section class="streams">
			<div class="container">
				...
				<h1 class="heading-one1">STREAMS</h1>
				<div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            WHERE c.status='1'
                            AND (
                                EXISTS (SELECT 1 FROM subcatagory s WHERE s.cat_id = c.id AND s.status='1')
                                OR
                                EXISTS (SELECT 1 FROM sub_subcategory ss WHERE ss.cat_id = c.id AND ss.status='1')
                            )
                            ORDER BY c.priority
                            ");
                            ...
                            <div class="col-md-6 mb-4">
                               <a href="career-option.php?id=<?=$id;?>">
                                 <div class="streams-img streams-img-pt text-center">
                                   <img src="stream-img/<?=$row['icon'];?>" class="img-fluid">
                                   <h4><?=$row['name'];?></h4>
                                 </div>
                               </a>
                            </div>
