...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='financial analyst' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="financial analyst.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ଆର୍ଥିକ-ବିଶ୍ଳେଷକ.php" class="language-odia">ଓଡିଆ</a>
