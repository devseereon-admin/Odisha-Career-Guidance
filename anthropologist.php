...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='anthropologist' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="anthropologist.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ମାନବବିଜ୍ଞାନୀ.php" class="language-odia">ଓଡିଆ</a>
