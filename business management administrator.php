...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='business management administrator' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="business management administrator.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ବିଜନେସ୍ ମ୍ୟାନେଜମେଣ୍ଟ୍ ପ୍ରଶାସକ.php" class="language-odia">ଓଡିଆ</a>
				...
				<div class="row">
					...
					<div class="col-md-9 border-psepho" >
						  ...
						  <div class="tab-content">
						    ...
						    <div id="menu1" class="contaner tab-pane fade">
