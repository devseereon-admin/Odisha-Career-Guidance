...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='mechanical-fitter' and status='1'");
			...
			<div class="col-md-10 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="mechanical-fitter.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ମେକାନିକାଲ୍-ଫିଟର୍.php" class="language-odia">Odia</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
