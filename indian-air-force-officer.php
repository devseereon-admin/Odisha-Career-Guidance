...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='indian-air-force-officer' and status='1'");
			...
			<div class="col-md-10 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="indian-air-force-officer.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ଭାରତୀୟ ବାୟୁସେନା ଅଧିକାରୀ.php" class="language-odia">ଓଡିଆ</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
