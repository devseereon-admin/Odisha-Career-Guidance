...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='forensic-scientist' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="forensic-scientist.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ଫରେନସିକ୍ ବୈଜ୍ଞାନିକ.php" class="language-odia">ଓଡିଆ</a>
