...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='sub-inspector-of-police' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="sub-inspector-of-police.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ସବ୍ ଇନ୍ସପେକ୍ଟର୍.php" class="language-odia">ଓଡିଆ</a>
