...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='lecturer' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="lecturer.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଅଧ୍ୟାପକ.php" class="language-odia">ଓଡିଆ</a>
