   ...
   if($option == 100)
{
    ...
    if (mysqli_affected_rows($conn) > 0) {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = "📩 New Submission |  strengths and weakness | [ENG]";
   ...
   if ($option == 101) {
    ...
    if (is_array($career_name) && !empty($career_name)) {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = "🎯 New Submission | Explore Your Interest|[ENG]";
    ...
    if($option == 400)
{
    ...
    $stmt = $conn->prepare("INSERT IGNORE INTO chatbot_tracking (option_name, user_ip) VALUES (?, ?)");
    $stmt->bind_param("ss", $option_name, $user_ip);
