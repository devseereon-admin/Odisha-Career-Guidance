...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='pharmacist' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="pharmacist.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଫାର୍ମାସିଷ୍ଟ.php" class="language-odia">ଓଡିଆ</a>
