...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='smart-phone-technician' and status='1'");
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="smart-phone-technician.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ସ୍ମାର୍ଟଫୋନ୍-ଟେକ୍ନିସିଆନ୍.php" class="language-odia">ଓଡିଆ</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
