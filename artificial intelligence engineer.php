...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='artificial intelligence engineer' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="artificial intelligence engineer.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ଆର୍ଟିଫିସିଆଲ୍ ଇଣ୍ଟେଲିଜେନ୍ସ୍ ଇଞ୍ଜିନିୟର୍.php" class="language-odia">ଓଡିଆ</a>
