...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='bank-po' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="bank-po.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ବ୍ୟାଙ୍କ୍ ପିଓ.php" class="language-odia">ଓଡିଆ</a>
