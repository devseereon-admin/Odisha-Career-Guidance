...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='sports coach' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="sports coach.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/କ୍ରୀଡ଼ା ପ୍ରଶିକ୍ଷକ.php" class="language-odia">ଓଡିଆ</a>
