...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='front-office-associate' and status='1'");
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="front-office-associate.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ଫ୍ରଣ୍ଟ୍-ଅଫିସ୍-ଆସୋସିଏଟ୍.php" class="language-odia">ଓଡିଆ</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
