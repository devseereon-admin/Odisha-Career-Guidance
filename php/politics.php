						...
						<article class="content">
						  <section>
						    <div class="row">
						        <div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="psephologist.html" class="btn-art-link">Psephologist</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Political Journalist</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Policy Advisor</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Academic/Professor</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Campaign Manager</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Public opinion</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Legislative </a> 
						    		</div>
						    	</div>
						    	
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Legislative assistant</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Economics</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						  ...
						  <section>
						    <div class="row">
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						    		<a href="#" class="btn-art-link">Geology</a> 
						    		</div>
						    	</div>
						    	<div class="col-md-6"> 
						    		<div class="btn-arts">
						  ...
						  <section>
						    ...
						    <p>Herp derpsum sherp cerp herpsum derpy tee. Derps de se derp sherp sherlamer terpus. Tee merp perp herpem derperker. Derpsum merp le perper sherp zerpus. Herpderpsmer sherper re perp dippy derpsum herpsum.</p>
