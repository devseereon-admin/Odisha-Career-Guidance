...
$cq_et = mysqli_fetch_assoc(mysqli_query($conn , "select * from subcatagory where `id`='$cid' and status = '1' "));
...
<!-- End Google Tag Manager (noscript) -->
		...
		<section class="arts">
			...
			<div class="container">
				...
				<h1 class="heading-one"><?=$cq_et['name'];?></h1>
					...
					<div class="col-md-8">
						...
						<article class="content">
						  ...
						  <section>
							...
							$subcatagory_et = mysqli_query($conn ,"select * from sub_subcategory where `subcat_id`='$cid' and status = '1' ");
...
<a href="<?=$res_subcatagory_et['slug']?>.php"
   class="btn-art-link"
   onclick="trackPageClick(['car3','<?=$res_subcatagory_et['name'];?>'], this)">
