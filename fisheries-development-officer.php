...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='fisheries-development-officer' and status='1'");
			...
			<div class="col-md-10 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="fisheries-development-officer.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ମତ୍ସ୍ୟ ଉନ୍ନୟନ ଅଧିକାରୀ.php" class="language-odia">ଓଡିଆ</a>
