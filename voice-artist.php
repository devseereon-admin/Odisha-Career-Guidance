...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='voice-artist' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="voice-artist.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଭଏସ୍ ଆର୍ଟିଷ୍ଟ.php" class="language-odia">ଓଡିଆ</a>
