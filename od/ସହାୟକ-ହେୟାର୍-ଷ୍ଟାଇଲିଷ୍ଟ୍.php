...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='ସହାୟକ-ହେୟାର୍-ଷ୍ଟାଇଲିଷ୍ଟ୍' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../assistant-hair-stylist.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ସହାୟକ-ହେୟାର୍-ଷ୍ଟାଇଲିଷ୍ଟ୍.php" class="language-eng">ଓଡିଆ</a>
