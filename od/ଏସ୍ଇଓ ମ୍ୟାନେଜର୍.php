...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ଏସ୍ଇଓ ମ୍ୟାନେଜର୍' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../seo-manager.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଏସ୍ଇଓ ମ୍ୟାନେଜର୍.php" class="language-eng">ଓଡିଆ</a>
