...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='କ୍ରୀଡ଼ା ପ୍ରଶିକ୍ଷକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../sports coach.php" class="language-odia">English</a>
			      	</div>
			      	<div class="language-en">
			      		<a href="କ୍ରୀଡ଼ା ପ୍ରଶିକ୍ଷକ.php" class="language-eng">ଓଡିଆ</a>
			      	</div>
