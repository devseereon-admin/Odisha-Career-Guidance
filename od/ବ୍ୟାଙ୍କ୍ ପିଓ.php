...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ବ୍ୟାଙ୍କ୍ ପିଓ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../bank-po.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ବ୍ୟାଙ୍କ୍ ପିଓ.php" class="language-eng">ଓଡିଆ</a>
