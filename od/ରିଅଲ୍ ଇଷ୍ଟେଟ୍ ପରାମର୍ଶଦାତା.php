...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ରିଅଲ୍ ଇଷ୍ଟେଟ୍ ପରାମର୍ଶଦାତା' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../real-estate-consultant.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ରିଅଲ୍ ଇଷ୍ଟେଟ୍ ପରାମର୍ଶଦାତା.php" class="language-eng">ଓଡିଆ</a>
