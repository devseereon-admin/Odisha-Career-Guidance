...
<!-- End Google Tag Manager (noscript) -->
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../college.php" class="language-odia">English</a>
			      	</div>
			      	<div class="language-en">
			      		<a href="college.php" class="language-eng">ଓଡିଆ</a>
			      	</div>
		...
		<section class="College">
			<div class="container">
				...
				<h1 class="heading-one">ମହାବିଦ୍ୟାଳୟ</h1>
				<div class="row">
...
function showdist(distidd){
	...
	<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K23TH38K"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
