...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ଗ୍ରାମୀଣ ଡାକ ସେବକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../gramin-dak-seva.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଗ୍ରାମୀଣ ଡାକ ସେବକ.php" class="language-eng">ଓଡିଆ</a>
