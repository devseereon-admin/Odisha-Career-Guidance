...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='ଗ୍ରାହକ-ସେବା-କାର୍ଯ୍ୟନିର୍ବାହୀ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../customer-care-executive.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଗ୍ରାହକ-ସେବା-କାର୍ଯ୍ୟନିର୍ବାହୀ.php" class="language-eng">ଓଡିଆ</a>
