...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='ନିର୍ବାଚନ-ବିଶ୍ଳେଷକ' and status='1'");
...
<!-- End Google Tag Manager (noscript) -->
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../psephologist.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ନିର୍ବାଚନ-ବିଶ୍ଳେଷକ.php" class="language-eng">ଓଡିଆ</a>
		...
		<section class="psephologist-one">
			...
			<div class="container">
				...
				<!--<h2 class="heading-one-two"></h2>-->

				<!--<h1 class="heading-one">ରାଜନୀତି ବିଜ୍ଞାନରେ ବୃତ୍ତି</h1>-->
