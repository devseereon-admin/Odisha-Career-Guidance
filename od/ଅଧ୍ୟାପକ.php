...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ଅଧ୍ୟାପକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../lecturer.php" class="language-odia">English</a>
			      	</div>
			      	<div class="language-en">
			      		<a href="ଅଧ୍ୟାପକ.php" class="language-eng">ଓଡିଆ</a>
			      	</div>
