...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ଏୟାର୍ ଟ୍ରାଫିକ୍ କଣ୍ଟ୍ରୋଲର୍' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../air-traffic-controller.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଏୟାର୍ ଟ୍ରାଫିକ୍ କଣ୍ଟ୍ରୋଲର୍.php" class="language-eng">ଓଡିଆ</a>
