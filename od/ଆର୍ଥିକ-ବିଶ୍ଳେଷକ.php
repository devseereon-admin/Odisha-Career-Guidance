...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='ଆର୍ଥିକ-ବିଶ୍ଳେଷକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../financial analyst.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଆର୍ଥିକ-ବିଶ୍ଳେଷକ.php" class="language-eng">ଓଡିଆ</a>
