...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ଭଏସ୍ ଆର୍ଟିଷ୍ଟ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../voice-artist.php" class="language-odia">ଇଂରାଜୀ</a>
			      	</div>
			      	<div class="language-en">
			      		<a href="ଭଏସ୍ ଆର୍ଟିଷ୍ଟ.php" class="language-eng">ଓଡିଆ</a>
			      	</div>
