...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='ସିଏଡି-ଗହଣା-ଡିଜାଇନର୍' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../cad-jewellery-designers.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ସିଏଡି-ଗହଣା-ଡିଜାଇନର୍.php" class="language-eng">ଓଡିଆ</a>
