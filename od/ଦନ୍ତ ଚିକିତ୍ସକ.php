...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ଦନ୍ତ ଚିକିତ୍ସକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../dentist.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଦନ୍ତ ଚିକିତ୍ସକ.php " class="language-eng">ଓଡିଆ</a>
