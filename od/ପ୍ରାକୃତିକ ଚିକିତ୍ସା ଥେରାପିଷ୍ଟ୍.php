...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ପ୍ରାକୃତିକ ଚିକିତ୍ସା ଥେରାପିଷ୍ଟ୍' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../naturopathy-therapist.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ପ୍ରାକୃତିକ ଚିକିତ୍ସା ଥେରାପିଷ୍ଟ୍.php" class="language-eng">ଓଡିଆ</a>
