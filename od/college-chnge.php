    ...
    <section class="College">
        ...
        <div class="container">
            ...
            <div class="College-round">
                ...
                <h1 class="heading-one1">ଶିକ୍ଷାନୁଷ୍ଠାନ</h1>
                        ...
                        <div class="filterfrm" style="background-color: #d5dde9;padding: 10px;">
                            ...
                            <form name="clgfrm" method="post" id='clgrtfrm'>
                                ...
                                <select class="form-select" name="institute" id="institute" required>
                                    ...
                                    <option value="">ଶିକ୍ଷାନୁଷ୍ଠାନ ପ୍ରକାର</option>
                                ...
                                <select class="form-select" name="Domain" id="Domain" onchange="changeDomain(this.value)" required>
                                    ...
                                    <option value="">ଡୋମେନ୍ ଚୟନ କରନ୍ତୁ</option>
                                ...
                                <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">ଦାଖଲ କରନ୍ତୁ</button>
...
document.getElementById('clgrtfrm').addEventListener('submit', function(e) {
    ...
    console.log('Tracking completed');
                        ...
                        <p>ଯଦି ଆପଣ ଓଡ଼ିଶାର ବ୍ଲକ ଅନୁଯାୟୀ ଶିକ୍ଷାନୁଷ୍ଠାନ ଦେଖିବାକୁ ଚାହୁଁଛନ୍ତି ତେବେ ଏଠାରେ ଚୟନ କରନ୍ତୁ</p>
                                                        ...
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                if ($description != '') {
                                                                    ...
                                                                    <th>କଳା ବିଭାଗରେ ପ୍ରଦାନ କରାଯାଉଥିବା ପାଠ୍ୟକ୍ରମ</th>
                                                                ...
                                                                if ($sciencecourse != '') {
                                                                    ...
                                                                    <th>ବିଜ୍ଞାନ ବିଭାଗରେ ପ୍ରଦାନ କରାଯାଉଥିବା ପାଠ୍ୟକ୍ରମ</th>
                                                                ...
                                                                if ($comercourse != '') {
                                                                    ...
                                                                    <th>ବାଣିଜ୍ୟ ବିଭାଗରେ ପ୍ରଦାନ କରାଯାଉଥିବା ପାଠ୍ୟକ୍ରମ</th>
...
<div class="content" style="padding-bottom:7px;">
    ...
    <script>
...

        {
            ...
            if(domainId == 1 || domainId == 4 || domainId == 5)
...
//=================================================================================Nutral ===================================================
            ...
            else if( domainId == 7 || domainId == 8 || domainId == 9)
...
// ==========================================================================form submit code =================================================
        ...
        $("#clgrtfrm").submit(function(e){
            ...
            else if(Domain == 7 || Domain == 8 || Domain == 9)
