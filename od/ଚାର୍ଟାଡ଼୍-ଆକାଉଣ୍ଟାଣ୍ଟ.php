...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='ଚାର୍ଟାଡ଼୍-ଆକାଉଣ୍ଟାଣ୍ଟ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../charted-accountant.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଚାର୍ଟାଡ଼୍-ଆକାଉଣ୍ଟାଣ୍ଟ.php" class="language-eng">ଓଡିଆ</a>
					...
					<div class="col-md-9 border-psepho" >
						  ...
						  <ul class="nav nav-tabs" role="tablist">
						    ...
						    <li class="nav-item">
						      ...
						      <a class="nav-link active" data-toggle="tab" href="#home">ଆବଶ୍ୟକ ଦକ୍ଷତା</a>
						    ...
						    <li class="nav-item">
						      ...
						      <a class="nav-link" data-toggle="tab" href="#menu2">ପ୍ରବେଶିକା</a>
