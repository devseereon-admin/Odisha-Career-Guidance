		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../event.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="event.php" class="language-eng">ଓଡିଆ</a>
...
<section id="gallery">
<div class="container">
    <h1 class="heading-one1">ଇଭେଣ୍ଟ ଫଟୋ</h1>
...
<div class="col-lg-4 col-md-6 mb-4">
  <a href="view-events.php?id=<?=$res_stm['id']?>" style="text-decoration:none;color:inherit;">
    ...
    <div class="event-card">
      ...
      <div class="event-img">
      <img src="od/upload/events/<?=$res_stm['cover_image']?>" alt="event">
      </div>
