...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ଖାଦ୍ୟ ନିରାପତ୍ତା ଅଧିକାରୀ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../food-safety-officer.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଖାଦ୍ୟ ନିରାପତ୍ତା ଅଧିକାରୀ.php" class="language-eng">ଓଡିଆ</a>
