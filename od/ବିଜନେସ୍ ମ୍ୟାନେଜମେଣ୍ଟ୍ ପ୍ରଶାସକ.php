...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ବିଜନେସ୍ ମ୍ୟାନେଜମେଣ୍ଟ୍ ପ୍ରଶାସକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../business management administrator.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ବିଜନେସ୍ ମ୍ୟାନେଜମେଣ୍ଟ୍ ପ୍ରଶାସକ.php" class="language-eng">ଓଡିଆ</a>
