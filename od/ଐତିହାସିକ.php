...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='ଐତିହାସିକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../historian.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଐତିହାସିକ.php" class="language-eng">ଓଡିଆ</a>
						      	...
						      	<div class="col-md-12">
						      		...
						      		<div class="row you-tube-channel">
						      			...
						      			<div class="col-md-11 col-9">
						      				...
						      				<p style="padding-top: 6px;"><b>ଅଧିକ ସୂଚନା ପାଇଁ, ଆମର ୟୁଟ୍ୟୁବ୍ ଚ୍ୟାନେଲ୍ ପରିଦର୍ଶନ ଜରନ୍ତୁ</b></p>
