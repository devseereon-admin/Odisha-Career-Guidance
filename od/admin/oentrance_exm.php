                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12 padding-0">
                                        ...
                                        <table id="example-11" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
											<?php
											$stm_sql = mysqli_query($conn,"select * from entnace_exam where status='1' ");
											$i=1;
											while($res_stm = mysqli_fetch_array($stm_sql)){

												$cid = $res_stm['id'];
												$institute_type = $res_stm['type'];
												
												$location = $res_stm['location'];
												$qualification=$res_stm['qualification'];
												
												
												$state_exe = mysqli_fetch_assoc(mysqli_query($conn ,"select * from qualification where id='$qualification' and status='1'"));
											...
											?>
												...
												<td><?=$cid;?></td>
													...
													?>
													 ...
													 <td>PG</td>
													 <?php
													}elseif($institute_type==3){
													 ?>
													  <td>Competitive exam for job</td>
													 <?php
													}
													 ?>
													  <td><?=$state_exe['name']?></td>
													 <?php
													if($location==1){
													?>
													  <td>Odisha</td>
													  ...
													  ?>
													    ...
													    <td><?=$res_stm['description']?></td>
														 <td><?=$res_stm['link']?></td> 
                                                    <td><a href="edit_clg.php?id=<?=$cid;?>">Edit</a></td>
