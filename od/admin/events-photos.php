                        ...
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <div class="actions panel_actions float-right">
                                   <a href="add-events-photos.php" style="background-color:#0f3970;color:#fff;padding: 10px;border-radius: 10px;">Add New</a>
                                </div>
                            </header>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 padding-0">
                                      <div class="table-container"> 
                                       <table id="example-11" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
											<?php
											$stm_sql = mysqli_query($conn,"select * from events_photos");
											while($res_stm = mysqli_fetch_array($stm_sql)){
												$cid = $res_stm['id'];
											?>
                                                <tr>
                                                    <td><img src="../upload/<?=$res_stm['thumbnail']?>" style="width:100px;height:100px;"></td>
                                                    <td><img src="../upload/<?=$res_stm['image']?>" style="width:100px;height:100px;"></td>
													<td><?=$res_stm['priority']?></td>
                                                    <td><a href="add-events-photos.php?id=<?=$res_stm['id']?>">Edit</a> <a href="delete-row.php?id=<?=$res_stm['id']?>&table=events_photos&page=events-photos.php">Delete</a></td>
