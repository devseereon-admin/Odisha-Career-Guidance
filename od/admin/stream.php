                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">List Of Streams</h2>
                                <div class="actions panel_actions float-right">
                                   <a href="add_stream.php" style="background-color:#0f3970;color:#fff;padding: 10px; border-radius: 10px;">Add New</a>
                                </div>
                            </header>
                            <div class="content-body">    <div class="row">
                                    ...
                                    <div class="table-container">
                                        <table id="example-11" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
											<?php
											$stm_sql = mysqli_query($conn,"select * from catagory where status='1' ");
											while($res_stm = mysqli_fetch_array($stm_sql)){
												$cid = $res_stm['id'];
											?>
                                                <tr>
                                                    <td><?=$res_stm['name']?></td>
                                                    <td><img src="../stream-img/<?=$res_stm['icon']?>" style="width:100px;height:100px;"></td>
                                                    <td><a href="edit_strm.php?id=<?=$cid;?>">Edit</a></td>
