...
$cnt = mysqli_num_rows(mysqli_query($conn ,"select * from detail where sid='$id' and status='1' "));


//echo $chk;
//exit;
if($cnt!=0){
$detl= mysqli_query($conn , "select * from detail where sid='$id' and status='1' ");
                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
									...
									<form name="careerfrm" method="post" action="detail_action.php" enctype="multipart/form-data">
									<?php
									if($cnt==0){
									?>
