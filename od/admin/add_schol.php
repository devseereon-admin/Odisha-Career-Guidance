...
$insert = mysqli_query($conn , "INSERT INTO `scholarship`( `name`, `class`,`type`, `link`, `description`, `eligibility_criteria`, `stipend`) VALUES
 ('$name','$class','$type','$link','$description','$eligibility_criteria','$stipend')");
                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
									...
									<form name="strmfrm" method="post" action="add_schol.php" enctype="multipart/form-data">
									<input type="hidden" name="action" value="add">
										<div class="form-group">
                                            <label class="form-label" for="field-1">Type 	</label>
                                            
                                            <div class="controls">
                                                <select class="custom-select" id="inputGroupSelect01" name="type" onchange="getclass(this.value)">
											...
											<div id='cls' style="display:none;">
										     ...
										     <select class="custom-select" id="inputGroupSelect01" name="class" >
                                                ...
                                                <option value='1'>1st - 5th</option>
											<option value='2'>6th - 8th</option>
												<option value='3'>9th - 10th</option>
													<option value='4'>11th - 12th</option>
													<option value='5'>Under Graduate</option>
