                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Professions</h1>                            </div>
                        ...
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <div class="actions panel_actions float-right">
                                   <a href="add_Prof.php" style="background-color:#0f3970;color:#fff;padding: 10px;
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12 padding-0">
                                        ...
                                        <table id="example-11" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
											<?php
											$stm_sql = mysqli_query($conn,"select * from sub_subcategory where status='1' ");
											$i=1;
											...
											?>
                                                <tr>
                                                    ...
                                                    <td><a href="add_detail.php?id=<?=$sub_id;?>" style="background-color:#fff;color:#000;padding:6px;border: 1px solid #000;
    ">Add Detail</a></td>
	 <td><a href="../<?=$slug;?>.php" style="background-color:#fff;color:#000;padding:6px;border: 1px solid #000;
    ">View Detail</a></td>
