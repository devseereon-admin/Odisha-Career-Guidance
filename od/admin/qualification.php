                    ...
                    <div class="col-xl-12">
                        ...
                        <section class="box ">
                            ...
                            <header class="panel_header">
                                ...
                                <h2 class="title float-left">List Of Qualification</h2>

                                <div class="actions panel_actions float-right">

                                   <a href="add_qualification.php" style="background-color:#0f3970;color:#fff;padding: 10px; border-radius: 10px;">Add New</a>
                            ...
                            <div class="content-body">    <div class="row">
                                    ...
                                    <div class="table-container">
                                        ...
                                        <table id="example-11" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
											...
											$stm_sql = mysqli_query($conn,"select * from qualification where status='1' ORDER BY id DESC");
											...
											?>
												...
												<td><?=$i;?></td>
													...
													?>
													  ...
													  <td><a href="edit_qualification.php?id=<?=$cid;?>">Edit</a> <a href="delete-row.php?id=<?=$cid;?>&table=qualification&page=qualification.php">Delete</a></td>
