...
/* ---------- CONFIG ---------- */
define('ODIA_DB', 'ama_career_odia');
$ODIA_DIR = '../od/upload/my-career/';

/* ---------- CREATE TABLE ---------- */
function checkAndCreateTable($conn)
{
    mysqli_select_db($conn, ODIA_DB);
...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['ajax_submit'])) {
    ...
    if (empty($id)) {
        ...
        $image = uploadFile('image', $ODIA_DIR);
    ...
    /* UPDATE */
        ...
        $newImage = uploadFile('image', $ODIA_DIR);
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (!empty($image)) { ?>
                                        <div class="image-preview" style="display:block;">
                                            ...
                                            <img src="../od/upload/my-career/<?= $image ?>">
