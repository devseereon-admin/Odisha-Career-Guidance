                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">List Of Professions</h2>
                                <div class="actions panel_actions float-right">
                                   <a href="add_Prof.php" style="background-color:#0f3970;color:#fff;padding: 10px; border-radius: 10px;">Add New</a>
                                </div>
                            </header>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 padding-0">
                                       <div class="table-container">
                                         <table id="example-11" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
											<?php
											$stm_sql = mysqli_query($conn,"SELECT * FROM sub_subcategory WHERE status='1' ORDER BY id DESC");
											$i=1;
											...
											?>
                                                <tr>
                                                    ...
                                                    <td><?=$res_stm['subcat_name'];?></td>
                                                    <td><a href="add_detail.php?id=<?=$sub_id;?>" style="background-color:#fff;color:#000;padding:6px;border: 1px solid #000;">Add Detail</a></td>
	                                                <td><a href="../<?=$slug;?>.php" style="background-color:#fff;color:#000;padding:6px;border: 1px solid #000;">View Detail</a></td>
                                                    <td>
                                                      <a href="delete-row.php?id=<?=$sub_id;?>&table=sub_subcategory&page=profesion.php"
                                                         onclick="return confirm('Are you sure you want to delete this item?');"
                                                         style="background-color:#fff;color:#000;padding:6px;border: 1px solid #000;">
                                                         Delete
                                                      </a>
                                                    </td>
