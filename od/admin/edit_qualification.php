...
$qual_det = mysqli_fetch_assoc(mysqli_query($conn , "select * from `qualification` where id='$qid' and status='1' "));
$institute_typ = $qual_det['institute_typ'];

if (!empty($_POST['action']) && $_POST['action'] == "update") {
	extract($_POST);
	//echo "UPDATE  `qualification` SET `name` ='$name' ,`institute_typ`='$institute_typ' WHERE id='$id' ";
	
$update = mysqli_query($conn , "UPDATE  `qualification` SET `name` ='$name' ,`institute_typ`='$institute_typ' WHERE id='$id' ");
...
if($insert){
        ...
        $msg = "Unable to add qualification";
        $alert = "danger";
    }
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Qualification</h1>                            </div>
...
<div class="col-xl-12 col-lg-12 col-12 col-md-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Add Qualification</h2>
                            ...
                            <div class="content-body">
                                <div class="row">
									...
									<form name="strmfrm" method="post" action="add_qualification.php" enctype="multipart/form-data">
									...
									<input type="hidden" name="id" value="<?=$qid;?>">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control" id="field-1" name="name" value="<?=$qual_det['name'];?>">
                                            </div>
                                        </div>
										  <div class="form-group">
