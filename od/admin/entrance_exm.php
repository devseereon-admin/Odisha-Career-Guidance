...
$query = "
SELECT e.*, q.name AS qualification_name 
FROM entnace_exam e 
LEFT JOIN qualification q ON e.qualification = q.id AND q.status='1'
WHERE e.status='1'
ORDER BY e.id DESC
";
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">entrance Exams</h1>                            </div>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">List Of entrance Exams</h2>
                                <div class="actions panel_actions float-right">
                                   <a href="add_exam.php" style="background-color:#0f3970;color:#fff;padding: 10px;
    border-radius: 10px;">Add New</a>
                                </div>
                            </header>
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12 padding-0">
                                         ...
                                         <div class="table-container">
                                            <table id="example-11" class="table table-striped nowrap" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>SL.No</th>
                                                        <th>Name</th>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)):
                                                    ...
                                                    $qualification = htmlspecialchars($row['qualification_name'] ?? '');
                                        
                                                    // Institute type
                                                    switch ($row['type']) {
                                                        case 1: $type = "UG"; break;
                                                        case 2: $type = "PG"; break;
                                                        case 3: $type = "Competitive Exam"; break;
                                                        default: $type = "N/A";
                                                    }
                                        
                                                    // Location
                                                    $location = ($row['location'] == 1) ? "Odisha" : "All India";
                                                ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_exam.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                        
                                                        <a href="delete-row.php?id=<?= $row['id']; ?>&table=entnace_exam&page=entrance_exam.php"
