...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ସାମ୍ବାଦିକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../journalist.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ସାମ୍ବାଦିକ.php" class="language-eng">ଓଡିଆ</a>
