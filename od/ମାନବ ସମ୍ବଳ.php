...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ମାନବ ସମ୍ବଳ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../human-resource.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ମାନବ ସମ୍ବଳ.php" class="language-eng">ଓଡିଆ</a>
					...
					<div class="col-md-9 border-psepho" >
						  ...
						  <ul class="nav nav-tabs" role="tablist">
						    ...
						    <li class="nav-item">
						      ...
						      <a class="nav-link" data-toggle="tab" href="#menu3">ଶିକ୍ଷା ଅନୁଷ୍ଠାନ</a>
						  ...
						  <div class="tab-content">
							...
							<div id="menu3" class="container tab-pane fade"><br>
						     ...
						     <h3 class="heading-for-tab">ଶିକ୍ଷା ଅନୁଷ୍ଠାନ</h3>

						     <h5><u>ଓଡିଶାରେ ଥିବା ଶିକ୍ଷା ଅନୁଷ୍ଠାନ</u></h5>

						    <?=$details['clg_od'];?>

						      <h5><u>ଭାରତରେ ଥିବା ଶିକ୍ଷା ଅନୁଷ୍ଠାନ</u></h5>

						       <?=$details['clg_in'];?>

						      <h5><u>ବିଦେଶରେ ଥିବା ଶିକ୍ଷା ଅନୁଷ୍ଠାନ</u></h5>
