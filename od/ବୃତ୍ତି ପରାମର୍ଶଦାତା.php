...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ବୃତ୍ତି ପରାମର୍ଶଦାତା' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../career-counsellor.php" class="language-odia">English</a>
			      	</div>
			      	<div class="language-en">
			      		<a href="ବୃତ୍ତି ପରାମର୍ଶଦାତା.php" class="language-eng">ଓଡିଆ</a>
			      	</div>
