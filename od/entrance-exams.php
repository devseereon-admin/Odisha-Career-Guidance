...
<!-- End Google Tag Manager (noscript) -->
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../entrance-exams.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="entrance-exams.php" class="language-eng">ଓଡିଆ</a>
		...
		<section class="College">
			...
			<div class="container">
				...
				<h1 class="heading-one">ପ୍ରବେଶିକା ପରୀକ୍ଷା</h1>
				...
				<div class="row">
					...
					<form name="entrcfrm" method="post" id='entrcfrm'>
						   ...
						   <select class="form-select" name="Domain" required onchange="getqualific(this.value);">
						     ...
						     <option value='1'>ସ୍ନାତକ </option>

						     <option value='2'>ସ୍ନାତକୋତ୍ତର </option>

						     <option value='3'>ପ୍ରତିଯୋଗିତାମୂଳକ ପରୀକ୍ଷା</option>
						    ...
						    <select class="form-select" name="Qual" id="dis" required>
						     ...
						     <option value="">ପାଠ୍ୟକ୍ରମ ଚୟନ କରନ୍ତୁ।</option>
						   ...
						   <select class="form-select" name="Loc" required>
						     ...
						     <option value="">ସ୍ଥାନ ଚୟନ କରନ୍ତୁ</option>

						     <option value="1">ରାଜ୍ୟ</option>

						     <option value="2">ଜାତୀୟ </option>
					...
					<div class="col-md-9">
						...
						$clg_exe = mysqli_query($conn ,"select * from entnace_exam where status = '1' group by `name`");
						...
						<h4 data-toggle='modal' data-target='#myModal<?=$c;?>'><?=$res_clgex['name'];?></h4>

						<a data-toggle='modal' data-target='#myModal<?=$c;?>' style="pointer:cursor;">ଅଧିକ ଜାଣନ୍ତୁ</a>&nbsp;&nbsp;<a href='<?=$res_clgex['link'];?>' target='_blank'>ପରିଦର୍ଶନ କରନ୍ତୁ</a>
    ...
    //     const examType = document.querySelector('[name="Domain"]').value;

    //     const qualification = document.querySelector('[name="Qual"]').value;

    //     const locationVal = document.querySelector('[name="Loc"]').value;
    ...
    //             body: `form_type=${formType}&click_type=location&item_id=${locationVal}`
    ...
    //     console.log("Entrance Exam Tracking Done ✔");



    //     // ⭐ EXISTING AJAX for result - keep same
