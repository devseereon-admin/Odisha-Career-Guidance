...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='ଫ୍ରଣ୍ଟ୍-ଅଫିସ୍-ଆସୋସିଏଟ୍' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../front-office-associate.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଫ୍ରଣ୍ଟ୍-ଅଫିସ୍-ଆସୋସିଏଟ୍.php" class="language-eng">ଓଡିଆ</a>
