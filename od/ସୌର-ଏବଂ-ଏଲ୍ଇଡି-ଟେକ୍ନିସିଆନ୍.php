...
$det_sub = mysqli_query($conn, "select * from subcatagory where slug='ସୌର-ଏବଂ-ଏଲ୍ଇଡି-ଟେକ୍ନିସିଆନ୍' and status='1' ");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../solar-&-led-technician.php" class="language-odia">English</a>
			      	</div>
			      	<div class="language-en">
			      		<a href="ସୌର-ଏବଂ-ଏଲ୍ଇଡି-ଟେକ୍ନିସିଆନ୍.php" class="language-eng">ଓଡିଆ</a>
			      	</div>
