...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ସିଭିଲ୍ ଇଞ୍ଜିନିୟର୍' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../civil-engineer.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ସିଭିଲ୍ ଇଞ୍ଜିନିୟର୍.php" class="language-eng">ଓଡିଆ</a>
