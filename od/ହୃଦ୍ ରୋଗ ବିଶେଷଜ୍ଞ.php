...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ହୃଦ୍ ରୋଗ ବିଶେଷଜ୍ଞ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../cardiologist.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ହୃଦ୍ ରୋଗ ବିଶେଷଜ୍ଞ.php" class="language-eng">ଓଡିଆ</a>
