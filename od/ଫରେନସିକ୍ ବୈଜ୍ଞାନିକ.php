...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='ଫରେନସିକ୍ ବୈଜ୍ଞାନିକ' and status='1'");
		...
		<section class ="bg-pattern header-menubg" >
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			        ...
			        <a href="../forensic-scientist.php" class="language-odia">English</a>

			      	</div>

			      	<div class="language-en">

			      		<a href="ଫରେନସିକ୍ ବୈଜ୍ଞାନିକ.php" class="language-eng">ଓଡିଆ</a>
