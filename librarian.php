...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='librarian' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="librarian.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଲାଇବ୍ରେରିଆନ୍.php" class="language-odia">ଓଡିଆ</a>
