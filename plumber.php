...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='plumber' and status='1'");
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="plumber.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ପ୍ଲମ୍ବର୍.php" class="language-odia">ଓଡିଆ</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
						      ...
						      <div class="row">
						      	<div class="col-md-12">
						      		...
						      		<div class="row yogendra-head">
						      				<a href="https://youtube.com/@odishacareerguidanceportal8840?si=ZUssJpgdl4SxSeMS"><img src="successtory-image/<?=$details['success_strimg'];?>" style="border-radius: 100px; width:100px;" class="img-fluid"></a>
