...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='dentist' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="dentist.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ଦନ୍ତ ଚିକିତ୍ସକ.php" class="language-odia">ଓଡିଆ</a>
