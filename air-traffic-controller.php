...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='air-traffic-controller' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="air-traffic-controller.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଏୟାର୍ ଟ୍ରାଫିକ୍ କଣ୍ଟ୍ରୋଲର୍.php" class="language-odia">ଓଡିଆ</a>
