...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='charted-accountant' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="charted-accountant.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ଚାର୍ଟାଡ଼୍-ଆକାଉଣ୍ଟାଣ୍ଟ.php" class="language-odia">ଓଡିଆ</a>
