...
$insert = mysqli_query($conn , "INSERT INTO `entnace_exam`( `name`, `qualification`, `type`, `location`, `description`, `link`) VALUES

 ('$name','$qualification','$institute_typ','$location','$about','$link')");
...
<div class="col-xl-12 col-lg-12 col-12 col-md-12">
                        ...
                        <section class="box ">
                            ...
                            <header class="panel_header">
                                ...
                                <h2 class="title float-left">Add Exam</h2>
                            ...
                            <div class="content-body">
                                ...
                                <div class="row">
									...
									<form name="strmfrm" method="post" action="add_exam.php" enctype="multipart/form-data">
