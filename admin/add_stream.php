...
if (!empty($_POST['action']) && $_POST['action'] == "add") {
	...
	if($chk){
$insert = mysqli_query($conn , "INSERT INTO `catagory`(`name` ,`icon`,`priority`)  VALUES ('$name' ,'$strm_img','$priority')");
                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
									...
									<form name="strmfrm" method="post" action="add_stream.php" enctype="multipart/form-data">
									<input type="hidden" name="action" value="add">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="file" value="" class="form-control" id="field-2" name="strm_img" required>
                                            </div>
                                        </div>
										 <div class="form-group">
                                            <label class="form-label" for="field-2">priority</label>
                                           
                                            <input type="text" class="form-control" id="field-1" name="priority" required>
                                        </div>
