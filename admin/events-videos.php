                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">EVENTS VIDEO</h1> 
                            </div>
                        ...
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <div class="actions panel_actions float-right">
                                   <a href="add-events-videos.php" style="background-color:#0f3970;color:#fff;padding: 10px;border-radius: 10px;">Add New</a>
                                </div>
                            </header>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12 padding-0">
                                       ...
                                       <table id="example-11" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
											<?php
											$stm_sql = mysqli_query($conn,"select * from events_videos");
											while($res_stm = mysqli_fetch_array($stm_sql)){
												$cid = $res_stm['id'];
											?>
                                                <tr>
                                                    <td> <?=$res_stm['videos']?> </td>
													<td><?=$res_stm['priority']?></td>
                                                    <td><a href="add-events-videos.php?id=<?=$res_stm['id']?>">Edit</a> <a href="delete-row.php?id=<?=$res_stm['id']?>&table=events_videos&page=events-videos.php">Delete</a></td>
