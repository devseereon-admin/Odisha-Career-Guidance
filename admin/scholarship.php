                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">List Of Scholarships</h2>
                                <div class="actions panel_actions float-right">
                                   <a href="add_schol.php" style="background-color:#0f3970;color:#fff;padding: 10px; border-radius: 10px;">Add New</a>
                                </div>
                            </header>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 padding-0">
                                       <div class="table-container">
                                        <table id="example-11" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
											<?php
											$stm_sql = mysqli_query($conn,"SELECT * FROM scholarship WHERE status='1' ORDER BY id DESC");
											$i=1;
											while($res_stm = mysqli_fetch_array($stm_sql)){
												...
												$description = $res_stm['description'];
												...
												<td><?=$i;?></td>
													...
													?>
													 ...
													 ?>
                                                      ...
                                                      $class_name = isset($class_list[$class]) ? $class_list[$class] : "";
                                                      ?>
                                                      <td><?=$class_name;?></td>
													  <td><?=$description;?></td>
													
													
													    <td><?=$res_stm['eligibility_criteria']?></td>
														 <td><?=$res_stm['stipend']?></td>
														 <td><?=$res_stm['link']?></td>
														 
                                                    <td><a href="edit_scholr.php?id=<?=$cid;?>">Edit</a> <a href="delete-row.php?id=<?=$cid;?>&table=scholarship&page=scholarship.php">Delete</a></td>
