...
$det_sub = mysqli_query($conn, "select * from  sub_subcategory where slug='indian-coast-guard' and status='1'");
					...
					<nav class="navbar navbar-expand-sm navbar-dark">
						...
						<div class="d-flex language">
							...
							<div class="language-en">
								...
								<a href="indian-coast-guard.php" class="language-eng">English</a>

							</div>

							<div class="language-od">

								<a href="od/ଭାରତୀୟ ତଟରକ୍ଷୀ ବାହିନୀ.php" class="language-odia">ଓଡିଆ</a>
