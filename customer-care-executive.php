...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='customer-care-executive' and status='1'");
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="customer-care-executive.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ଗ୍ରାହକ-ସେବା-କାର୍ଯ୍ୟନିର୍ବାହୀ.php" class="language-odia">ଓଡିଆ</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
				...
				<div class="row">
					...
					<div class="col-md-9 border-psepho" >
						  ...
						  <ul class="nav nav-tabs" role="tablist">
						    ...
						    <!--</li>-->
						    <!--<li class="nav-item">-->
						    <!--  <a class="nav-link" data-toggle="tab" href="#menu4">Scholarship</a>-->
						    <!--</li>-->
						    <li class="nav-item">
