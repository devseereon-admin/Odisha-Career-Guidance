...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='assistant-hair-stylist' and status='1'");
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="assistant-hair-stylist.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ସହାୟକ-ହେୟାର୍-ଷ୍ଟାଇଲିଷ୍ଟ୍.php" class="language-odia">ଓଡିଆ</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
