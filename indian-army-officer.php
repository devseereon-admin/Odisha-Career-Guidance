...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='indian-army-officer' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="indian-army-officer.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ଆର୍ମି ଅଫିସର୍.php" class="language-odia">ଓଡିଆ</a>
