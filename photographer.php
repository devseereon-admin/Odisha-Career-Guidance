...
$det_sub = mysqli_query($conn ,"select * from subcatagory where slug='photographer' and status='1'");
			...
			<div class="col-md-2 col-6">
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		<a href="photographer.php" class="language-eng">English</a>
			      	</div>
			        <div class="language-od">
			        <a href="od/ଫଟୋଗ୍ରାଫର୍.php" class="language-odia">ଓଡିଆ</a>
			      	</div>
			      	</div>
				</nav> 
			</div>
					...
					<div class="col-md-9 border-psepho" >
						  ...
						  <div class="tab-content">
						    ...
						    <?=$details['clg_od'];?>
						     ...
						     <!--<?=$details['schlr_od'];?>-->
						      <h5><u>Scholarships in India</u></h5><br>
