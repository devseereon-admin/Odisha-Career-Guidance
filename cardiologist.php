...
$det_sub = mysqli_query($conn ,"select * from  sub_subcategory where slug='cardiologist' and status='1'");
			...
			<div class="col-md-2 col-6">
				...
				<nav class="navbar navbar-expand-sm navbar-dark">
			      	...
			      	<div class="language-en">
			      		...
			      		<a href="cardiologist.php" class="language-eng">English</a>

			      	</div>

			        <div class="language-od">

			        <a href="od/ହୃଦ୍ ରୋଗ ବିଶେଷଜ୍ଞ.php" class="language-odia">ଓଡିଆ</a>
